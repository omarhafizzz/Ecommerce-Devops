...
# ============================================================
# حط الـ IPs بتاعت الـ K8s nodes هنا
# ============================================================
K8S_MASTER_IP="10.0.1.210"
K8S_WORKER1_IP="10.0.1.143"
K8S_WORKER2_IP="10.0.1.203"
# ============================================================
...
wget -q https://grafana.com/api/dashboards/1860/revisions/latest/download \
...
echo "  Dashboard  : Node Exporter Full (auto-imported)"
echo "======================================================"
